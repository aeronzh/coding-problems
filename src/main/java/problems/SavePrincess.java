 ...
 * the grid. This is followed by an NxN grid. Each cell is denoted by '-' (ascii
 * value: 45). The bot position is denoted by 'm' and the princess position is
 * denoted by 'p'.
 * 
 ...
 * Output format
 * 
 * Print out the moves you will take to rescue the princess in one go. The moves
 * must be separated by '\n', a newline. The valid moves are LEFT or RIGHT or UP
 * or DOWN.
 * 
 * 
 * Sample input
 ...
 * 
 * Scoring Your score is calculated as follows : (NxN - number of moves made to
